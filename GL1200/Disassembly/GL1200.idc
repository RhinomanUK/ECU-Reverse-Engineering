...
#define id x
	...
	ExtLinA		(0X0,	8,	";          cpx - some of these aren't tested");
	ExtLinA		(0X0,	9,	";          some misaligned branches ");
	ExtLinA		(0X0,	10,	"; A second 40-pin chip contains an ADC and some other ");
	ExtLinA		(0X0,	11,	"; (TBD - timer and port expander?) functions ");
	ExtLinA		(0X0,	12,	"; There are a total of 5202 bytes of code      ");
	ExtLinA		(0X0,	13,	"; Date: 21st December 2023");
	MakeByte	(0X0);
	MakeName	(0X0,	"P1DDR");
	MakeComm	(0X1,	"=1Eh");
	MakeName	(0X1,	"P2DDR");
