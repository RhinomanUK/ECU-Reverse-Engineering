...
#define id x
	...
	ExtLinA		(0X0,	8,	"; There are a total of 5202 bytes of code      ");
	ExtLinA		(0X0,	9,	"; Date: 12th December 2023");
	MakeByte	(0X0);
	MakeName	(0X0,	"P1DDR");
	MakeComm	(0X1,	"=1Eh");
	MakeName	(0X1,	"P2DDR");
	...
	ExtLinA		(0XA3,	4,	";  bit 5 (0x20): Set on IC1 interrupt");
	...
	MakeCode	(0XE909);
	MakeComm	(0XE911,	"not a valid address!");
	...
	MakeRptCmt	(0XF545,	"clear bit2 and save ???");
	MakeCode	(0XF548);
	MakeCode	(0XF553);
