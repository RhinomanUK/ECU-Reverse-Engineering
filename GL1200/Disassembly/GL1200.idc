...
#define id x
	...
	ExtLinA		(0X0,	7,	";          cpx - some of these aren't tested");
	ExtLinA		(0X0,	8,	";          some misaligned branches ");
	ExtLinA		(0X0,	9,	"; A second 40-pin chip contains an ADC and some other ");
	ExtLinA		(0X0,	10,	"; (TBD - timer and port expander?) functions ");
	ExtLinA		(0X0,	11,	"; There are a total of 5202 bytes of code      ");
	ExtLinA		(0X0,	12,	"; Date: 22nd December 2023");
	MakeByte	(0X0);
	MakeName	(0X0,	"P1DDR");
	MakeComm	(0X1,	"=1Eh");
	MakeName	(0X1,	"P2DDR");
	...
	MakeByte	(0XC);
	MakeName	(0XC,	"OCR1L");
	MakeRptCmt	(0XD,	"ICR1 is never read - external timer?");
	MakeByte	(0XD);
	MakeName	(0XD,	"ICR1H");
	MakeByte	(0XE);
	MakeName	(0XE,	"ICR1L");
	...
	MakeByte	(0X7E);
	MakeName	(0X7E,	"dCPS_Count");
	MakeRptCmt	(0X80,	"= dCPS_Count/2");
	MakeByte	(0X80);
	MakeName	(0X80,	"dCPS_Count_T1");
	MakeByte	(0X82);
	MakeName	(0X82,	"CPS_Count");
	MakeByte	(0X84);
	MakeName	(0X84,	"count_84");
	MakeComm	(0X85,	"cleared on every CPS interrupt");
	MakeByte	(0X85);
	...
	ExtLinA		(0X88,	0,	"");
	ExtLinA		(0X88,	1,	"dCPS_Av_2 - this is  17bit number");
	ExtLinA		(0X88,	2,	"dCPS_AV_2 = dCPS_AV /2");
	MakeByte	(0X88);
	MakeName	(0X88,	"dCPS_Av_2H");
	MakeRptCmt	(0X89,	"middle byte");
	MakeByte	(0X89);
	MakeName	(0X89,	"dCPS_Av_2M");
	MakeRptCmt	(0X8A,	"low byte");
	MakeByte	(0X8A);
	MakeName	(0X8A,	"dCPS_Av_2L");
	ExtLinA		(0X8B,	0,	"");
	ExtLinA		(0X8B,	1,	"dCPS_AV - this is a 17-bit number");
	ExtLinA		(0X8B,	2,	"dCPS_Av = dCPS_Av + (0.5 * lastdCPS_Av)");
	MakeByte	(0X8B);
	MakeName	(0X8B,	"dCPS_AvH");
	MakeRptCmt	(0X8C,	"= (dCPS_Count/2) + dCPS_Av");
	MakeByte	(0X8C);
	MakeName	(0X8C,	"dCPS_AvM");
	...
	ExtLinA		(0XA2,	8,	";  bit 1 (0x02): new dCPS value ");
	...
	ExtLinA		(0XA3,	6,	";  bit 3 (0x08): 0 clears dCPS_Av_2");
	...
	ExtLinA		(0XE000,	0,	"; File Name   : P:\\ECUs_no_sync\\GL1200\\Disassembly\\GL1200.bin");
	ExtLinA		(0XE000,	1,	"; Format      : Binary file");
	ExtLinA		(0XE000,	2,	"; Base Address: 0000h Range: E000h - 10000h Loaded length: 2000h");
	MakeWord	(0XE000);
	...
	MakeComm	(0XE058,	"count_98 max.value");
	MakeByte	(0XE058);
	MakeWord	(0XE060);
	...
	OpBinary	(x,	0);
	MakeCode	(0XE880);
	MakeRptCmt	(0XE886,	"A=16");
	MakeCode	(0XE88A);
	MakeRptCmt	(0XE88C,	"clear status_A3 bit3");
	MakeComm	(0XE88E,	"A = 10h or 0Fh or 07h");
	MakeRptCmt	(0XE890,	"bra if A=0");
	MakeRptCmt	(0XE892,	"else A = Fh, Eh or 6h");
	MakeRptCmt	(0XE893,	"A-byte_84");
	MakeRptCmt	(0XE895,	"bra if not zero");
	MakeRptCmt	(0XE899,	"else test status_A3 bit5");
	MakeRptCmt	(0XE89D,	"increment (count_84)");
	MakeComm	(0XE89E,	"update count_84");
	MakeName	(0XE8A0,	"inc_count_98");
	MakeComm	(0XE8A3,	"count_98 - Bh");
	MakeCode	(x=0XE8A3);
	OpOff		(x,	0,	0X0);
	OpOff		(x,	128,	0X0);
	MakeRptCmt	(0XE8A6,	"bra if count_98>Bh");
	MakeRptCmt	(0XE8A8,	"else update count_98");
	MakeCode	(0XE8AB);
	MakeCode	(0XE8B2);
	ExtLinA		(0XE900,	0,	"; IC_IntHandler:");
	ExtLinA		(0XE900,	1,	"; IC1 is ??");
	ExtLinA		(0XE900,	2,	"; IC2 is the crank sensor input");
	MakeCode	(0XE900);
	...
	MakeComm	(0XED1F,	"pointer to IGN value");
	...
	MakeComm	(0XED85,	"pointer to injector value");
	...
	MakeComm	(0XEDCE,	"else dCPS_Count - byte_B1");
	MakeWord	(0XEE00);
	MakeWord	(0XEE02);
	MakeWord	(0XEE04);
	MakeWord	(0XEE06);
	...
	MakeComm	(0XF1CC,	"calculate Baro correction");
	MakeCode	(0XF1CC);
	MakeName	(0XF1CC,	"MAP_F1CC");
	MakeRptCmt	(0XF1CE,	"MAP * Baro");
	MakeComm	(0XF1CF,	"(MAP*Baro)*2");
	MakeComm	(0XF1D2,	"set to max. if overflow");
	MakeCode	(0XF1D9);
	MakeCode	(0XF1E8);
	...
	MakeComm	(0XF463,	"IGN_F463:\n called with X = 40h or 48h");
	MakeCode	(0XF463);
	MakeName	(0XF463,	"ign_F463");
	MakeCode	(0XF47A);
	MakeName	(0XF47A,	"doTick_65ms");
	MakeComm	(0XF481,	"always call");
	MakeCode	(0XF485);
	...
	MakeComm	(0XF610,	"1x8 16-bit table");
	...
	MakeCode	(0XF6AF);
	MakeCode	(0XF6BB);
	ExtLinA		(0XF6C1,	0,	"clear dCAS_Av_2 if status_A3 bit3 = 0");
	MakeRptCmt	(0XF6C3,	"High:Middle bytes");
	MakeRptCmt	(0XF6C5,	"low byte");
	ExtLinA		(0XF6CB,	0,	"execute if status_A3 bit3=1");
	MakeCode	(0XF6CB);
	MakeComm	(0XF6CD,	"clear status_A3 bit3");
	MakeComm	(0XF6D1,	"bra if A = 7h or Fh");
	MakeRptCmt	(0XF6D3,	"else A = Eh or 6h");
	MakeRptCmt	(0XF6D6,	"bra if A != Eh or 6h");
	MakeComm	(0XF6D8,	"else test status_A3 bit5");
	MakeRptCmt	(0XF6DC,	"bra if status_A3 bit3 !=0");
	MakeRptCmt	(0XF6DE,	"increment (count_84)");
	MakeComm	(0XF6DF,	"update count_84");
	ExtLinA		(0XF6E1,	0,	"update count_98");
	MakeRptCmt	(0XF6E6,	"bra if count_98<4");
	MakeRptCmt	(0XF6E8,	"else update count_98");
	MakeCode	(0XF6EB);
	MakeRptCmt	(0XF6EF,	"set byte_A6 bit0");
	MakeCode	(0XF6F2);
	MakeRptCmt	(0XF6F6,	"clear byte_A6 bit0");
	MakeRptCmt	(0XF6F9,	"clear count_98");
	...
	MakeCode	(0XF776);
	MakeCode	(0XF77C);
	MakeName	(0XF77C,	"IC2_F77C");
	MakeComm	(0XF786,	"bra if !IC2 IF");
	MakeCode	(0XF79A);
	MakeRptCmt	(0XF79E,	"dCPS_Count = ICR2H - CPS_Count");
	MakeRptCmt	(0XF7A2,	"CPS_Count = ICR2H");
	MakeCode	(0XF7B2);
	MakeComm	(0XF7B8,	"counts between CAS interrupts");
	ExtLinA		(0XF7B8,	0,	"");
	ExtLinA		(0XF7B8,	1,	"; count_4ms_B must be between 61.44ms and");
	ExtLinA		(0XF7B8,	2,	"; 81.92ms o0r count_4ms_B gets reset??");
	MakeRptCmt	(0XF7BA,	"65.5ms timeout");
	MakeComm	(0XF7BC,	"bra if <65.5ms");
	MakeRptCmt	(0XF7C0,	"else bra if> 81.92ms");
	MakeRptCmt	(0XF7C2,	"test for RPM up or down");
	MakeRptCmt	(0XF7C4,	"bra if dCPS_Count >8000h");
	MakeComm	(0XF7C6,	"else set to max.");
	MakeComm	(0XF7C9,	"and update");
	MakeRptCmt	(0XF7CC,	"clear the 4ms counter");
	MakeComm	(0XF7D0,	"dCPS_Count/2");
	MakeComm	(0XF7D1,	"add to the running average");
	MakeComm	(0XF7D3,	"test for overflow");
	MakeComm	(0XF7D5,	"inc the software extended counter");
	MakeComm	(0XF7D8,	"update the average value");
	MakeComm	(0XF7DA,	"also inc byte_AD");
	MakeComm	(0XF7E0,	"bra if dCPS_Count <8000h");
	MakeRptCmt	(0XF7E2,	"else set to max.");
	...
	MakeCode	(0XF876);
	MakeComm	(0XF87F,	"clear byte_50");
	MakeComm	(0XF883,	"(count_84++)");
	MakeComm	(0XF884,	"(count_84) - 10h");
	MakeRptCmt	(0XF886,	"bra if (count_84)<10h");
	MakeRptCmt	(0XF888,	"redundant code");
	MakeComm	(0XF891,	"set count_84 to max?");
	MakeComm	(0XF893,	"update count_84 (n or max)");
	MakeCode	(0XF89C);
	MakeCode	(0XF8C4);
	...
	MakeCode	(0XF942);
	MakeComm	(0XF95E,	"pointer to injector value");
	MakeCode	(0XF974);
	MakeCode	(0XF990);
	MakeCode	(0XF995);
	MakeComm	(0XF99F,	"pointer to injector value");
	MakeCode	(0XF99F);
	MakeComm	(0XF9AC,	"redirects to loc_FAEB");
	MakeCode	(0XF9BB);
	MakeComm	(0XF9BE,	"pointer to ign value");
	MakeCode	(0XF9C4);
	MakeCode	(0XF9C7);
	...
	MakeComm	(0XFA0D,	"pointer to ign value");
	MakeCode	(0XFA0D);
	MakeCode	(0XFA29);
	MakeComm	(0XFA2C,	"pointer to injector value");
	MakeCode	(0XFA53);
	...
	MakeCode	(0XFABB);
	MakeName	(0XFABB,	"dCPS_FABB");
	MakeCode	(0XFAC9);
	MakeComm	(0XFACF,	"dCPS_AvH /2");
	MakeComm	(0XFAD7,	"dCPS_Av /2?");
	MakeComm	(0XFADE,	"new dCPS?");
	MakeName	(0XFAE0,	"clear_dCPS_Av");
	MakeRptCmt	(0XFAE6,	"clear byte_AD");
	MakeCode	(0XFAE9);
	MakeComm	(0XFAF5,	"pointer to ign value");
	MakeComm	(0XFB00,	"pointer to injector value");
	MakeCode	(0XFB06);
	MakeCode	(0XFB26);
	...
	MakeComm	(0XFC78,	"pointer to ign value");
	MakeComm	(0XFC7E,	"pointer to injector value");
	MakeCode	(0XFC85);
	MakeComm	(0XFC8C,	"pointer to ign value");
	MakeCode	(0XFC91);
	MakeName	(0XFC91,	"OC2_IntHandler?");
	MakeComm	(0XFC94,	"pointer to injector value");
	MakeCode	(0XFC9A);
	MakeCode	(0XFCA7);
	...
	MakeCode	(0XFD37);
	MakeCode	(0XFD60);
	MakeComm	(0XFD75,	"pointer to ign value");
	MakeCode	(0XFD9A);
	...
	MakeCode	(0XFE7A);
	MakeName	(0XFE7A,	"limits_FE7A");
	MakeComm	(0XFE88,	"is this not the return address???");
	MakeCode	(0XFE88);
	MakeName	(0XFE88,	"limits_FE88");
...
static Functions_0(void) {
	...
	SetFunctionFlags(0XE880,0x0);
	MakeFunction    (0XEA00,0XEA34);
	SetFunctionFlags(0XEA00,0x400);
	MakeFunction    (0XEA34,0XEA8B);
	SetFunctionFlags(0XEA34,0x400);
	MakeFunction    (0XEB00,0XEB0D);
	SetFunctionFlags(0XEB00,0x400);
	MakeFrame(0XEB00, 0X0, 0, 0X0);
	MakeFunction    (0XEB11,0XEB1D);
	SetFunctionFlags(0XEB11,0x400);
	MakeFrame(0XEB11, 0X0, 0, 0X0);
	MakeFunction    (0XEB22,0XEB39);
	SetFunctionFlags(0XEB22,0x400);
	MakeFunction    (0XEB68,0XEB74);
	SetFunctionFlags(0XEB68,0x400);
	MakeFunction    (0XEB90,0XEBB8);
	SetFunctionFlags(0XEB90,0x400);
	MakeFrame(0XEB90, 0X0, 0, 0X0);
	MakeFunction    (0XEBBD,0XEBD3);
	SetFunctionFlags(0XEBBD,0x400);
	...
	MakeFunction    (0XF16E,0XF17B);
	SetFunctionFlags(0XF16E,0x400);
	MakeFrame(0XF16E, 0X0, 0, 0X0);
	MakeFunction    (0XF17F,0XF18E);
	SetFunctionFlags(0XF17F,0x400);
	MakeFrame(0XF17F, 0X0, 0, 0X0);
	MakeFunction    (0XF190,0XF1A7);
	SetFunctionFlags(0XF190,0x400);
	MakeFunction    (0XF1C0,0XF1CC);
	SetFunctionFlags(0XF1C0,0x400);
	MakeFunction    (0XF1CC,0XF1D7);
	SetFunctionFlags(0XF1CC,0x400);
	MakeFunction    (0XF1D9,0XF1EC);
	SetFunctionFlags(0XF1D9,0x400);
	MakeFunction    (0XF1EC,0XF260);
	SetFunctionFlags(0XF1EC,0x400);
	MakeFunction    (0XF260,0XF26E);
	SetFunctionFlags(0XF260,0x400);
	MakeFunction    (0XF26E,0XF287);
	SetFunctionFlags(0XF26E,0x400);
	MakeFunction    (0XF289,0XF2AC);
	SetFunctionFlags(0XF289,0x400);
	MakeFunction    (0XF2AC,0XF342);
	SetFunctionFlags(0XF2AC,0x400);
	MakeFunction    (0XF342,0XF34D);
	SetFunctionFlags(0XF342,0x400);
	MakeFunction    (0XF34F,0XF3B0);
	SetFunctionFlags(0XF34F,0x400);
	...
	MakeFunction    (0XF492,0XF494);
	SetFunctionFlags(0XF492,0x400);
	MakeFrame(0XF492, 0X0, 0, 0X0);
	MakeFunction    (0XF49B,0XF4E5);
	SetFunctionFlags(0XF49B,0x400);
	...
	MakeFunction    (0XF563,0XF58E);
	SetFunctionFlags(0XF563,0x400);
	MakeFrame(0XF563, 0X0, 0, 0X0);
	MakeFunction    (0XF590,0XF5A6);
	SetFunctionFlags(0XF590,0x400);
	MakeFunction    (0XF5C3,0XF5E6);
	SetFunctionFlags(0XF5C3,0x400);
	...
	SetFunctionFlags(0XF6BB,0x0);
	MakeFunction    (0XF6FC,0XF706);
	SetFunctionFlags(0XF6FC,0x400);
	MakeFunction    (0XF7B8,0XF8FA);
	SetFunctionFlags(0XF7B8,0x400);
