...
#define id x
	...
	MakeByte	(0XD2);
	MakeByte	(0XF9);
	MakeComm	(0XC000,	"only read compared to 56h\nbit7 is ctrl bit\nbit0 is status - action on 1");
	MakeByte	(0XC000);
	...
	MakeCode	(0XF47A);
	ExtLinA		(0XF485,	0,	"ADC_F484:");
	ExtLinA		(0XF485,	1,	"Wait for ADC? called with 27, 2A, 2B or 2C");
	ExtLinA		(0XF485,	2,	"sets A bit2 when complete");
	MakeCode	(0XF485);
	MakeName	(0XF485,	"ADC_F485");
	MakeCode	(0XF492);
	MakeCode	(0XF49A);
	MakeCode	(0XF4AF);
	MakeCode	(0XF4CE);
